...
import { Loader2, UserPlus, Warehouse, ArrowLeft } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <Card className="border-border shadow-none bg-background animate-in zoom-in-95 duration-500">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold">{t.registerTitle[locale]}</CardTitle>
            <CardDescription>
              {t.registerSubtitle[locale]}
            </CardDescription>
          </CardHeader>
          <CardContent>
